...
class NewMealDialog extends StatefulWidget {
  ...
  final Meal? meal;
  const NewMealDialog(
      {Key? key, required this.addNewMeal, required this.isEditting, this.meal, required this.removeMeal})
      : super(key: key);
          ...
          Container(
            ...
            child: TextFormField(
              decoration: InputDecoration(
                  ...
                  errorText: _validateName ? "Coloque um nome válido!" : null),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                widget.isEditting
                    ? IconButton(
                        onPressed: () {widget.removeMeal(widget.meal);
                        Navigator.pop(context);},
                        icon: const Icon(
                          Icons.delete,
                          size: 35,
